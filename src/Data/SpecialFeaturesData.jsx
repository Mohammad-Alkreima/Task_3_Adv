...
const SpecialFeaturesData = [
    {
        icon: "assets/img/academics/icon-1.png",
    ...
    {
        icon: "assets/img/academics/icon-2.png",
    ...
    {
        icon: "assets/img/academics/icon-3.png",
    ...
    {
        icon: "assets/img/academics/icon-5.png",
    ...
    {
        icon: "assets/img/academics/icon-6.png",
...
export default SpecialFeaturesData
